...
function! s:Ack(cmd, args)
  ...
  if l:apply_mappings
    ...
    exec "nnoremap <silent> <buffer> t <C-W>gf"
    exec "nnoremap <silent> <buffer> T <C-W>gf<C-W>TgT<C-W><C-W>"
    exec "nnoremap <silent> <buffer> o <CR>"
    exec "nnoremap <silent> <buffer> go <CR><C-W><C-W>"
    exec "nnoremap <silent> <buffer> h <C-W>w<C-W>s<C-W>bo<C-W>K"
    exec "nnoremap <silent> <buffer> H <C-W>w<C-W>s<C-W>bo<C-W>K<C-W>b"
    exec "nnoremap <silent> <buffer> v <C-W>w<C-W>v<C-W>b<CR>"
    exec "nnoremap <silent> <buffer> gv <C-W>w<C-W>v<C-W>b<CR><C-W>b"
  endif
